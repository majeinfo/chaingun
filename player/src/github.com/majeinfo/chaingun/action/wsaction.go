...
func (h WSAction) Execute(resultsChannel chan reporter.SampleReqResult, sessionMap map[string]string, vucontext *config.VUContext, vulog *log.Entry, playbook *config.TestDef) bool {
    return DoWSRequest(h, resultsChannel, sessionMap, vucontext, vulog, playbook)
}
